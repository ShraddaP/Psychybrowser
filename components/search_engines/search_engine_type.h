...
enum SearchEngineType {
  ...
  SEARCH_ENGINE_AHMIA = 82,
  SEARCH_ENGINE_TORCH = 83,
  SEARCH_ENGINE_DARKSEARCH = 84,
  SEARCH_ENGINE_NOT_EVIL = 85,
  SEARCH_ENGINE_HAYSTAK = 86,
  SEARCH_ENGINE_ONION_LINKS = 87,
  SEARCH_ENGINE_HAYSTACK = 88,
